...
//     initialize() {
//         db.exec(`
//       CREATE TABLE IF NOT EXISTS tokens (workspace_id TEXT PRIMARY KEY, access_token TEXT);
...
//     saveTokens(workspaceId: string, accessToken: string) {
//         db.prepare('INSERT OR REPLACE INTO tokens VALUES (?, ?)').run(workspaceId, accessToken);
//     },
