...
//     if (response.data.ok) {
//       console.log('Slack Auth Response:', response.data);
//       db.saveTokens(response.data.team.id, response.data.access_token);
//       res.redirect('http://localhost:5173'); // Frontend homepage
//     } else {
